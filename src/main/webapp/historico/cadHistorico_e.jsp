...
<html>
	...
	<body class="bg-secondary">
		...
		<div class="container">
			<s:form action="/updateHistorico.action">
				...
				<div class="card mt-5">
					...
					<div class="card-body">
						<div class="row align-items-center">
							...
							<div class="col-sm-2">
								<s:textfield cssClass="form-control" id="idExame" name="historicoVo.exame.rowid"/>							
							</div>	
						</div>
						...
						<div class="row align-items-center">
							...
							<div class="col-sm-2">
								<s:textfield cssClass="form-control" id="idFuncionario" name="historicoVo.funcionario.rowid"/>							
							</div>	
						</div>
						...
						<div class="row align-items-center mt-3">
							...
							<div class="col-sm-5">
								<s:textfield type="hidden" cssClass="form-control" id="data" name="historicoVo.rowid"/>							
							</div>	
						</div>
					</div>
